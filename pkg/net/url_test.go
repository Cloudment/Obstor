...
func TestURLString(t *testing.T) {
	testCases := []struct {
		...
		{URL{Scheme: "https", Host: "play.pgg.net:80"}, "https://play.pgg.net:80"},
...
func TestURLMarshalJSON(t *testing.T) {
	testCases := []struct {
		...
		{URL{Scheme: "https", Host: "play.pgg.net:0"}, []byte(`"https://play.pgg.net:0"`), false},
...
func TestURLUnmarshalJSON(t *testing.T) {
	testCases := []struct {
		...
		{[]byte(`"https://play.pgg.net:0"`), &URL{Scheme: "https", Host: "play.pgg.net:0"}, false},
...
func TestParseHTTPURL(t *testing.T) {
	testCases := []struct {
		...
		{"https://play.pgg.net:0", &URL{Scheme: "https", Host: "play.pgg.net:0"}, false},
