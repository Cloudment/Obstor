...
func compareXLMetaV1(t *testing.T, unMarshalXLMeta, jsoniterXLMeta xlMetaV1Object) {
	...
	if unMarshalXLMeta.Obstor.Release != jsoniterXLMeta.Obstor.Release {
		t.Errorf("Expected the Release string to be \"%s\", but got \"%s\".", unMarshalXLMeta.Obstor.Release, jsoniterXLMeta.Obstor.Release)
	}
