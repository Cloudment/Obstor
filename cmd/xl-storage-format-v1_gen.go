	...
	for zb0001 > 0 {
		...
		case "Obstor":
			...
			for zb0003 > 0 {
				...
				switch msgp.UnsafeString(field) {
				case "Release":
					z.Obstor.Release, err = dc.ReadString()
					if err != nil {
						err = msgp.WrapError(err, "Obstor", "Release")
						return
					}
				default:
					err = dc.Skip()
...
func (z *xlMetaV1Object) EncodeMsg(en *msgp.Writer) (err error) {
	...
	err = en.WriteString(z.Obstor.Release)
	if err != nil {
		err = msgp.WrapError(err, "Obstor", "Release")
		return
	}
...
func (z *xlMetaV1Object) MarshalMsg(b []byte) (o []byte, err error) {
	...
	o = msgp.AppendString(o, z.Obstor.Release)
	// string "Meta"
	...
	for zb0001 > 0 {
		...
		case "Obstor":
			...
			for zb0003 > 0 {
				...
				switch msgp.UnsafeString(field) {
				case "Release":
					z.Obstor.Release, bts, err = msgp.ReadStringBytes(bts)
					if err != nil {
						err = msgp.WrapError(err, "Obstor", "Release")
						return
					}
...
func (z *xlMetaV1Object) Msgsize() (s int) {
	s = 1 + 8 + msgp.StringPrefixSize + len(z.Version) + 7 + msgp.StringPrefixSize + len(z.Format) + 5 + 1 + 5 + msgp.Int64Size + 8 + msgp.TimeSize + 8 + z.Erasure.Msgsize() + 6 + 1 + 8 + msgp.StringPrefixSize + len(z.Obstor.Release) + 5 + msgp.MapHeaderSize
	if z.Meta != nil {
		for za0001, za0002 := range z.Meta {
			_ = za0002
