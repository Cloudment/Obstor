# ObStor Security Overview [![Discord](https://discord.pgg.net/discord?type=svg)](https://discord.pgg.net)
...
More details about supported KMS implementations and configuration can be found at the [KMS guide](https://github.com/cloudment/obstor/blob/master/docs/kms/README.md).
