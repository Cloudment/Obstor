...
| `minio_cluster_nodes_offline_total`          | Total number of ObStor nodes offline.                                                                                |
| `minio_cluster_nodes_online_total`           | Total number of ObStor nodes online.                                                                                 |
...
| `minio_node_file_descriptor_limit_total`     | Limit on total number of open file descriptors for the ObStor Server process.                                        |
| `minio_node_file_descriptor_open_total`      | Total number of open file descriptors by the ObStor Server process.                                                  |
...
| `minio_node_process_starttime_seconds`       | Start time for ObStor process per node, time in seconds since Unix epoc.                                             |
| `minio_node_process_uptime_seconds`          | Uptime for ObStor process per node in seconds.                                                                       |
...
| `minio_software_commit_info`                 | Git commit hash for the ObStor release.                                                                              |
| `minio_software_version_info`                | ObStor Release tag for the server                                                                                    |
