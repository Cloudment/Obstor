...
![put](https://raw.githubusercontent.com/cloudment/obstor/master/docs/bucket/versioning/versioning_PUT_versionEnabled.png)
...
![delete](https://raw.githubusercontent.com/cloudment/obstor/master/docs/bucket/versioning/versioning_DELETE_versionEnabled.png)
...
![get](https://raw.githubusercontent.com/cloudment/obstor/master/docs/bucket/versioning/versioning_GET_versionEnabled.png)

GET requests by specifying a version ID as shown below, you can retrieve the specific object version `fae684da`.

![get_version_id](https://raw.githubusercontent.com/cloudment/obstor/master/docs/bucket/versioning/versioning_GET_versionEnabled_id.png)
...
![delete_version_id](https://raw.githubusercontent.com/cloudment/obstor/master/docs/bucket/versioning/versioning_DELETE_versionEnabled_id.png)
...
public class EnableVersioning {
  ...
  public static void main(String[] args)
    ...
    try {
      /* play.pgg.net for test and development. */
      MinioClient minioClient =
          MinioClient.builder()
              .endpoint("https://play.pgg.net")
